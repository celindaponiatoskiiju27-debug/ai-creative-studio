...
insert into public.model_configs (type, provider, model_id, name, description, text_model_id, sort_order, credit_cost)
values
  ('image', 'openai', 'gpt-image-2', 'GPT Image 2', '高质量商品图片生成', '', 10, 2),
  ('text', 'aliyun', 'qwen-plus', '通义千问 Plus', '默认：高性价比电商文案与提示词润色', '', 10, 1),
  ('text', 'openai', 'gpt-5.4', 'GPT-5.4', '备用：百炼服务故障时自动兜底', '', 20, 2),
  ('video', 'aliyun', 'wan2.6-i2v-flash', '通义万相 2.6', '图生 GIF 与文生视频', 'wan2.6-t2v', 10, 6),
  ('video', 'fal', 'fal-ai/ltx-video/image-to-video', 'LTX Video', 'fal.ai 图生动态备用模型', '', 20, 6)
