...
values
  ...
  ('image', 'tencent', 'hunyuan-image', '腾讯混元生图', '国内备用 · 配置腾讯云密钥后开放', '', 30, 3, 3, true, false, false),
  ('image', 'tencent', 'hunyuan-image-edit', '腾讯混元图片编辑', '国内备用 · 配置腾讯云密钥后开放', '', 30, 4, 4, false, true, false),
