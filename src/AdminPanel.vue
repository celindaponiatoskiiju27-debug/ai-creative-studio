...
export default {
  ...
  computed: {
    adminNavItems() { return [{ id: 'overview', icon: '⌂', name: '数据概览' }, { id: 'announcement', icon: '◉', name: '公告管理' }, { id: 'users', icon: '♙', name: '用户管理' }, { id: 'billing', icon: '¥', name: '充值与套餐' }, { id: 'growth', icon: '↗', name: '邀请增长' }, { id: 'support', icon: '☏', name: '人工客服' }, { id: 'cost', icon: '◫', name: '成本控制' }, { id: 'risk', icon: '!', name: '内容风控' }, { id: 'system', icon: '⚙', name: '系统与审计' }] },
